...
def main():
    ...
    parser.add_argument('--p_reg', '-p_reg', help='path of file for regulators of the orginal network')
    parser.add_argument('--p_target', '-p_target', help='path of file for target genes of the original network')
